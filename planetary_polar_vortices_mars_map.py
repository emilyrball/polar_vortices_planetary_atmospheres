...
if __name__ == "__main__":
    ...
    ds = ds.assign_coords(time = ["MY 28", "MY 29-32"])

    ds.to_netcdf('link-to-anthro/Mitchell_etal_2021/data_marsPVmap.nc')

    plt.subplots_adjust(hspace=.17,wspace=.04)
